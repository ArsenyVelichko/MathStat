...
for i=1:n
    plot(dat(i,1),dat(i,2),'ko', 'MarkerEdgeColor',[0 0 0],'MarkerFaceColor', cnames(fragn(i)));
    %scatter3(dat(i,1), dat(i,2), dat(i,3), 'ko', 'MarkerEdgeColor',[0 0 0], 'MarkerFaceColor',cnames(fragn(i)));
    hold on;
end
